...
export const HomeIconActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
      <g>
...
export const HomeIconDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const Logo = ({ fillColor }) => {
  return (
    <svg width={100} focusable="false" fill={fillColor} style={iconStyle}>
      <svg
...
export const Menu = ({ fillColor }) => {
  return (
    <svg width={25} height={25} fill={fillColor} style={iconStyle}>
...
export const HistoryActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
      <path d="M14.97 16.95 10 13.87V7h2v5.76l4.03 2.49-1.06 1.7zM12 2C8.73 2 5.8 3.44 4 5.83V3.02H2V9h6V7H5.62C7.08 5.09 9.36 4 12 4c4.41 0 8 3.59 8 8s-3.59 8-8 8-8-3.59-8-8H2c0 5.51 4.49 10 10 10s10-4.49 10-10S17.51 2 12 2z" />
    </svg>
  );
};
export const HistoryDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
      <g>
...
export const ShortsIconActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const ShortsIconDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const SubscriptionsActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const SubscriptionsDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const YourChannel = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const PlaylistActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
      <path d="M15 19v-8l7 4-7 4Zm7-12H2v2h20V7Zm-9 6H2v-2h11v2Zm0 4H2v-2h11v2Z" />
    </svg>
  );
};
export const PlaylistDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const YourvideosDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const WatchlaterActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm2.97 14.95L10 13.87V7h2v5.76l4.03 2.49-1.06 1.7z" />
    </svg>
  );
};
export const WatchlaterDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const LikedvideosActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const LikedvideosDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const YourclipsActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const YourclipsDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const TrendingDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const ShoppingDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
      <path d="M7 8c0 2.76 2.24 5 5 5s5-2.24 5-5h-1c0 2.21-1.79 4-4 4s-4-1.79-4-4H7zm9.9-2c-.46-2.28-2.48-4-4.9-4S7.56 3.72 7.1 6H4v14c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6h-3.1zM12 3c1.86 0 3.43 1.27 3.87 3H8.13c.44-1.73 2.01-3 3.87-3zm7 17c0 .55-.45 1-1 1H6c-.55 0-1-.45-1-1V7h14v13z" />
    </svg>
  );
};
export const MusicDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const MoviesDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
      <path d="m22.01 4.91-.5-2.96L1.64 5.19 2 8v13h20V8H3.06l18.95-3.09zM5 9l1 3h3L8 9h2l1 3h3l-1-3h2l1 3h3l-1-3h3v11H3V9h2z" />
    </svg>
  );
};
export const LiveDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
      <g>
...
export const GamingDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const NewsDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const SportsDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const CoursesDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const FashionAndBeautyDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const PodcastsDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const SettingsDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const ReporthistoryDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const HelpDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
...
export const SendfeedbackDeActive = ({ fillColor }) => {
  return (
    <svg height={24} width={24} fill={fillColor} style={iconStyle}>
